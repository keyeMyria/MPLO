  ...
  render() {
    ...
    return(
      <View style = {styles.container}>
        ...
        <TouchableOpacity style={styles.createButtonContainer} onPress={()=>this.navigateToNextScreen('MPLO.USER_REGISTER_SCREEN')}>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserCreateProfile);
